...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(SeatUnavaliableException.class)
    public ResponseEntity<?> seatUnavailableException(SeatUnavaliableException ex, WebRequest request) {
    ...
    public ResponseEntity<?> globalExceptionalHandler(Exception ex, WebRequest request) {
        ex.printStackTrace(); // Crucial: This shows the EXACT error in your terminal!
        ErrorResponse errorDetails = new ErrorResponse(
                new Date(),
